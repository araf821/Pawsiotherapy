...
const AnimalCard: React.FC<AnimalCardProps> = ({
  ...
  return (
    <div
      ...
      } mx-auto w-full max-w-[400px] rounded-lg bg-slate-50 capitalize shadow-md transition duration-300 hover:-translate-y-4 hover:shadow-2xl hover:shadow-zinc-600`}
    >
      {/* Image Container */}
